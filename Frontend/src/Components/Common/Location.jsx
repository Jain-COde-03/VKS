...
const Location = () => {
  ...
  return (
    <div className='flex min-w-0 w-full items-center gap-2 rounded-3xl border border-emerald-100 bg-white/95 px-2 py-2 shadow-[0_10px_30px_rgba(15,23,42,0.06)] sm:w-auto sm:gap-3 sm:rounded-full sm:px-2.5 sm:py-1.5'>
        ...
        >
          ...
          <DialogContent sx={{ px: { xs: 2, sm: 3 } }}>
            <Box className='flex flex-col items-start gap-4'>
              <Box className='w-full rounded-[20px] border border-emerald-100 bg-white p-3 shadow-sm sm:rounded-3xl sm:p-4'>
              ...
              <List className='w-full! rounded-[20px]! border! border-emerald-100! bg-white! p-2! shadow-sm sm:rounded-3xl!'>
