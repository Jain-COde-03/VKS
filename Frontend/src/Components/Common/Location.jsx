...
const Location = () => {
    ...
    return (
        <div className='flex w-full min-w-0 items-center gap-2 rounded-3xl border border-emerald-100 bg-white/95 px-2 py-2 shadow-[0_10px_30px_rgba(15,23,42,0.06)] sm:w-auto sm:gap-3 sm:rounded-full sm:px-2.5 sm:py-1.5'>
